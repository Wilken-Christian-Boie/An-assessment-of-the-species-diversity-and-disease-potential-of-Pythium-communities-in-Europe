...
boxplot2(Globisporangium.attrantheridium ~ Year+Country, data=DATA, main="Globisporangium.attrantheridium", xlab="", ylab="", las=3,
...
# Which years differ?
comp1 <- lsmeans(mod3, specs="Year", contr="pairwise")$contrasts
summary(as.glht(comp1, by=NULL, alternative="two.sided"))
export_stats(summary(as.glht(comp1, by=NULL, alternative="two.sided")), "Globisporangium_attrantheridium")
...
comp1 <- lsmeans(mod3, specs="Year", contr="pairwise")$contrasts
summary(as.glht(comp1, by=NULL, alternative="two.sided"))
export_stats(summary(as.glht(comp1, by=NULL, alternative="two.sided")), "Globisporangium_heterothallicum")
...
# residual analysis:
#windows(); plot(mod3, main="Globisporangium sylvaticum")
...
comp1 <- lsmeans(mod3, specs="Year", contr="pairwise")$contrasts
summary(as.glht(comp1, by=NULL, alternative="two.sided"))
export_stats(summary(as.glht(comp1, by=NULL, alternative="two.sided")), "Globisporangium_sylvaticum")


# Pythium aff._hydnosporum
# boxplot:
#windows(10,7); par(mfrow=c(1,1), mar=c(10, 4, 4, 2) + 0.1)
boxplot2(Pythium.aff._hydnosporum ~ Year+Country, data=DATA, main="Pythium aff._hydnosporum", xlab="", ylab="", las=3,
  col=rainbow(length(levels(DATA$Year))))
...
# residual analysis:
#windows(); plot(mod3, main="Pythium aff._hydnosporum")
...
comp1 <- lsmeans(mod3, specs="Year", contr="pairwise")$contrasts
summary(as.glht(comp1, by=NULL, alternative="two.sided"))
export_stats(summary(as.glht(comp1, by=NULL, alternative="two.sided")), "Pythium_aff_hydnosporum")
...
comp1 <- lsmeans(mod3, specs="Year", contr="pairwise")$contrasts
summary(as.glht(comp1, by=NULL, alternative="two.sided"))
export_stats(summary(as.glht(comp1, by=NULL, alternative="two.sided")), "Pythium_monospermum")
...
comp1 <- lsmeans(mod3, specs="Year", contr="pairwise")$contrasts
summary(as.glht(comp1, by=NULL, alternative="two.sided"))
export_stats(summary(as.glht(comp1, by=NULL, alternative="two.sided")), "Pythium_arrhenomanes")
...
comp1 <- lsmeans(mod3, specs="Year", contr="pairwise")$contrasts
summary(as.glht(comp1, by=NULL, alternative="two.sided"))
export_stats(summary(as.glht(comp1, by=NULL, alternative="two.sided")), "Globisporangium_rostratifingens")



# Globisporangium.ultimum_var._ultimum
# boxplot:
#windows(10,7); par(mfrow=c(1,1), mar=c(10, 4, 4, 2) + 0.1)
boxplot2(Globisporangium.ultimum_var._ultimum ~ Year+Country, data=DATA, main="Globisporangium.ultimum_var._ultimum", xlab="", ylab="", las=3,
  col=rainbow(length(levels(DATA$Year))))
...
# residual analysis:
#windows(); plot(mod3, main="Globisporangium ultimum_var._ultimum")
...
comp1 <- lsmeans(mod3, specs="Year", contr="pairwise")$contrasts
summary(as.glht(comp1, by=NULL, alternative="two.sided"))
export_stats(summary(as.glht(comp1, by=NULL, alternative="two.sided")), "Globisporangium_ultimum_var._ultimum")
...
comp1 <- lsmeans(mod3, specs="Year", contr="pairwise")$contrasts
summary(as.glht(comp1, by=NULL, alternative="two.sided"))
export_stats(summary(as.glht(comp1, by=NULL, alternative="two.sided")), "Globisporangium_intermedium")
...
comp1 <- lsmeans(mod3, specs="Year", contr="pairwise")$contrasts
summary(as.glht(comp1, by=NULL, alternative="two.sided"))
export_stats(summary(as.glht(comp1, by=NULL, alternative="two.sided")), "Globisporangium_apiculatum")
